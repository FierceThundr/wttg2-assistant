...
var sitedata = {
    ...
    <h1>The Breather</h1>
      ...
      <p>Normally, it is unlikely for the Breather to spawn on a visit to the alley. However, as you get more keys throughout the game, the chance for him to spawn will go up. To know if he is active on a visit to the alley, listen for any potential sound cues when passing the dumpster. <i>(Sound cues can be found below)</i> If you hear a sound (or you are not sure) you should go into the nearby closet in the alley and prepare to brace the door by clicking on the handle. You can look through the window in an attempt to see him, but you should not let him see you. If he begins to push the door, immediately hold the doorknob. (Keep in mind that this minigame is very strict and will result in death upon failure) After he gives up, you should stop holding to prepare for his next attempt. Repeat this process until he leaves. After you hear him walking away you must wait a few more seconds so that he doesn't catch you. Then you can simply grab your packages and return to the building.</p>
 	  <details>
